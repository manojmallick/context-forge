...
description: Latest saved task benchmark for SigMap v8.29.0. 64.8% correct, 45.7% fewer prompts, 81.1% hit@5 across 105 tasks, with R language support.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-09-01 (v8.29.0)** — Now includes R language support (ggplot2, dplyr, shiny)
