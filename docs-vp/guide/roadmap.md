...
head:
  ...
  - - meta
    - property: og:description
      content: "99 versions shipped. See what changed in each release and what is coming next."
  - - meta
    - property: og:url
...
Ninety-nine versions shipped. MIT open source from day one.
