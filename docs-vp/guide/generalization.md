...
description: SigMap generalizes across 21 repos, 33 languages, and multiple domains with 82.2% hit@5 in the latest saved v8.23.0 retrieval run.
head:
  - - meta
    - property: og:title
      content: "SigMap Generalization — 82.2% hit@5 across 33 languages with R support"
  - - meta
...
::: info Official v8.23.0 benchmark snapshot
**Benchmark ID:** sigmap-v8.23-main &nbsp;·&nbsp; **Date:** 2026-07-28 (with R language)
...
these 105 tasks is yes — 82.2% hit@5 with no per-repo tuning in the latest saved v8.23.0 run.
:::
...
If you want one number to carry into launch messaging, use the shared `v8.23.0` snapshot rather than an older per-page variant:
