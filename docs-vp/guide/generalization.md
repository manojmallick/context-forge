...
description: SigMap generalizes across 21 repos, 33 languages, and multiple domains with 81.1% hit@5 in the latest saved v8.29.0 retrieval run.
head:
  - - meta
    - property: og:title
      content: "SigMap Generalization — 81.1% hit@5 across 33 languages with R support"
  - - meta
...
::: info Official v8.29.0 benchmark snapshot
**Benchmark ID:** sigmap-v8.29-main &nbsp;·&nbsp; **Date:** 2026-09-01 (with R language)
...
these 105 tasks is yes — 81.1% hit@5 with no per-repo tuning in the latest saved v8.29.0 run.
:::
...
If you want one number to carry into launch messaging, use the shared `v8.29.0` snapshot rather than an older per-page variant:
