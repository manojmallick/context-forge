...
description: Latest saved retrieval benchmark for SigMap v8.26.0. 81.1% hit@5 vs 44.0% single-shot grep baseline (1.73× honest lift) across 105 tasks on 18 repos, with R language support.
head:
  - - meta
    - property: og:title
