...
description: What token reduction means operationally in v8.30.0. 16/21 repos overflow GPT-4o without SigMap, 5,200+ files would be hidden, and input-cost savings reach $9,900+/month (GPT-4o), $11,900+ (Claude Sonnet), or $3,900+ (Claude Haiku) at 10 calls/day.
head:
  - - meta
    - property: og:title
...
Latest saved run: **2026-09-07 (v8.30.0)**
